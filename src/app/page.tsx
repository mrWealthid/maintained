						...
						<div className='flex flex-col items-center space-y-8 text-center max-w-4xl mx-auto'>
							<div className='space-y-6'>
								...
								<p className='mx-auto max-w-2xl text-lg leading-relaxed text-gray-600 dark:text-gray-300 sm:text-xl'>
									Complete property management platform for
									modern businesses. Handle applications,
					...
					<div className='container mx-auto px-4'>
						<div className='flex flex-col items-center space-y-4 text-center mb-16'>
							...
							<p className='max-w-2xl text-lg text-gray-600 dark:text-gray-300'>
								Integrated platform designed for property
								managers, real estate professionals, and housing
								organizations.
							</p>
						</div>
						<div className='grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto'>
							<Card className='border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'>
								<CardHeader className='pb-4'>
									...
									<CardDescription className='text-gray-600 dark:text-gray-300 leading-relaxed'>
										...
										intelligent filtering, virtual tours,
										and automated matching algorithms.
									</CardDescription>
								</CardHeader>
								<CardContent>
							...
							<Card className='border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'>
								<CardHeader className='pb-4'>
									...
									<CardDescription className='text-gray-600 dark:text-gray-300 leading-relaxed'>
										Streamlined maintenance workflow with
										automated routing, real-time tracking,
							...
							<Card className='border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800'>
								<CardHeader className='pb-4'>
									...
									<CardDescription className='text-gray-600 dark:text-gray-300 leading-relaxed'>
										Professional listing management with
										automated screening, digital contracts,
				...
				<section className='w-full py-16 md:py-24'>
					<div className='container mx-auto px-4'>
						<div className='flex flex-col items-center space-y-4 text-center mb-16'>
							...
							<p className='max-w-2xl text-lg text-gray-600 dark:text-gray-300'>
								Our streamlined onboarding process gets your
						...
						<div className='flex flex-col items-center space-y-8 text-center max-w-3xl mx-auto'>
							<div className='space-y-4'>
								...
								<p className='text-lg text-gray-600 dark:text-gray-300 leading-relaxed'>
									Join industry leaders who trust ApartmentHub
									to streamline their property management
									processes.
								</p>
							</div>
							...
							<p className='text-sm text-gray-500 dark:text-gray-400'>
								Free 30-day trial • No setup fees • Cancel
								anytime
							</p>
						</div>
					</div>
					...
					<div className='grid gap-8 md:grid-cols-4'>
						<div className='space-y-4'>
							...
							<p className='text-sm text-gray-600 dark:text-gray-400 leading-relaxed'>
								Enterprise-grade housing management platform
