...
import { SpecialtyBadges } from "./InviteUsersForm";
import { Property } from "@/features/onboarding/model/model";
import { useFetchUnits } from "@/features/onboarding/hooks/onboardingHooks";

const InviteUsersFormRow = ({
  field,
  index,
  properties,
...
export default InviteUsersFormRow;
